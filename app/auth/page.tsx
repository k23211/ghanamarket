    ...
    <div style={{
      ...
      <div style={{ position: "relative", zIndex: 1, width: "100%", maxWidth: 420 }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          ...
          <div>
            <span style={{ fontWeight: 900, fontSize: 30, color: "#fff", letterSpacing: -1 }}>Ghana</span>
            <span style={{ fontWeight: 900, fontSize: 30, color: "#f5a623", letterSpacing: -1 }}>Market</span>
          </div>
